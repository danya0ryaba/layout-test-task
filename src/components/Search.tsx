...
export const Search: React.FC = () => {
    return (
        <div className='search'>
            ...
            <svg className='search_svg' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_20_822)">
            ...
            <input type="text" className="search_input" placeholder='Search for something' />
