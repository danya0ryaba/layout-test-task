        ...
        <div className="wrapper_form">
            ...
            <div className="form">
                ...
                <ul className="form_choice">
                    <li className='form_choice_li active' onClick={() => setActiveChoice(1)}>Edit Profile</li>
                    <li className='form_choice_li' onClick={() => setActiveChoice(2)}>Preferences</li>
                    <li className='form_choice_li' onClick={() => setActiveChoice(3)}>Security</li>
                </ul>
